      ...
      <main className="relative z-20 mt-28">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-4xl mx-auto px-6 text-white">
                ...
                <p className="mt-4 text-lg max-w-2xl">
                  Need help? Every small donation counts. Contribute food,
                  clothes, or money and bring a smile to someone’s face today.
                </p>
                <div className="mt-6 flex gap-4">
                  ...
                  <Button
                    variant="outline"
                    className="border-white text-black/90 hover:bg-white/10"
                  >
                    Discover
                  </Button>
                </div>
        ...
        <section id="causes" className="max-w-6xl mx-auto px-6 py-14">
          <div className="mb-6">
            ...
            <p className="text-slate-600">
              Support meaningful causes in your community.
            </p>
          </div>
      ...
      <footer className="relative z-20 w-full border-t bg-white/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-md border grid place-items-center font-bold text-indigo-700 bg-white/90 shadow-sm">
                  GW
                </div>
                <div>
